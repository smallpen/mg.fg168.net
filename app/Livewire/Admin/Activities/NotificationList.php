        ...
        try {
            ...
            \Log::info('🔄 resetFilters - 篩選重置開始', [
                ...
                'before_reset' => [
                    ...
                    'priorityFilter' => $this->priorityFilter ?? 'all',
                    'statusFilter' => $this->statusFilter ?? 'all',
                    'userFilter' => $this->userFilter ?? 'all',
            ...
            $this->js('
                ...
                setTimeout(() => {
                    ...
                    dateInputs.forEach(input => {
                        if (input.getAttribute("wire:model.live") === "dateFrom") {
                            input.value = "' . Carbon::now()->subDays(7)->format('Y-m-d') . '";
                        } else if (input.getAttribute("wire:model.live") === "dateTo") {
