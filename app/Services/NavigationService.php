    ...
    protected array $menuStructure = [
        ...
        [
            ...
            'children' => [
                ...
                [
                    'key' => 'roles.statistics',
                    'title' => '角色統計',
                    'route' => 'admin.roles.statistics',
                    'permission' => 'roles.view',
                    'order' => 3,
                ],
                [
                    'key' => 'roles.permission-matrix',
                    'title' => '權限矩陣',
                    'route' => 'admin.roles.permission-matrix',
        ...
        [
            ...
            'children' => [
                ...
                [
                    'key' => 'activities.monitor',
                    'title' => '即時監控',
                    'route' => 'admin.activities.monitor',
                    'permission' => 'system.logs',
                    'order' => 2,
                ],
                [
