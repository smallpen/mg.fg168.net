        ...
        <form wire:submit="createPlayer">
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        您的剩餘點數：{{ number_format($agent->remaining_points, 2) }}
                    </p>
                ...
                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                            <span class="text-gray-500 dark:text-gray-400">隸屬代理：</span>
                            <span class="font-medium text-gray-900 dark:text-white">{{ $agent->name }}</span>
                        </div>
                        <div>
                            <span class="text-gray-500 dark:text-gray-400">代理帳號：</span>
                            <span class="font-medium text-gray-900 dark:text-white">{{ $agent->account }}</span>
                        </div>
                    </div>
                </div>
            </div>
