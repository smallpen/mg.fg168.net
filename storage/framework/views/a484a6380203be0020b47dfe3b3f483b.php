    ...
    <div class="card">
        <div class="card-body">
            ...
            <form wire:submit.prevent="login" class="space-y-6">
                ...
                <!-- 使用者名稱 -->
                <div>
                    <label for="username" class="form-label"><?php echo e(__('auth.login.username')); ?></label>
                    <input id="username" 
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="<?php echo e(__('auth.validation.username_required')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- 密碼 -->
                <div>
                    <label for="password" class="form-label"><?php echo e(__('auth.login.password')); ?></label>
                    <input id="password" 
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="<?php echo e(__('auth.validation.password_required')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="#" class="font-medium text-primary-600 hover:text-primary-500">
                            <?php echo e(__('passwords.forgot') ?? '忘記密碼？'); ?>
                ...
                <div>
                    <button type="submit" 
                        ...
                        <span wire:loading.remove><?php echo e(__('auth.login.submit')); ?></span>
...
</div><?php /**PATH /home/chris/Projects/Taipei_Projects/mg.fg168.net/resources/views/livewire/admin/auth/login-form.blade.php ENDPATH**/ ?>