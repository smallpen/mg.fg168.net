<div class="min-h-screen bg-gray-50 dark:bg-slate-900" x-data="{ 
    ...
    init() {
        ...
        window.addEventListener('resize', () => {
            ...
            if (this.isMobile !== newIsMobile) {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('setMobileMode', newIsMobile);
            }
        });
        
        // 初始化時設定行動裝置模式
        window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('setMobileMode', this.isMobile);
    }
}">
    
    <!-- 遮罩層（僅在行動裝置模式下顯示） -->
    <div class="<?php echo e($this->getLayoutClasses()['overlay']); ?>" 
    ...
    <!-- 側邊導航選單 -->
    <aside class="<?php echo e($this->getLayoutClasses()['sidebar']); ?>">
        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('admin.layout.sidebar');

$__html = app('livewire')->mount($__name, $__params, 'lw-2629429800-0', $__slots ?? [], get_defined_vars());
...
?>
    ...
    <!-- 主內容區域 -->
    <div class="<?php echo e($this->getLayoutClasses()['main']); ?>">
...
[$__name, $__params] = $__split('admin.layout.top-bar');

$__html = app('livewire')->mount($__name, $__params, 'lw-2629429800-1', $__slots ?? [], get_defined_vars());
...
<script>
    ...
    document.addEventListener('keydown', function(e) {
        ...
        if (e.key === 'Escape' && window.innerWidth < 1024) {
            window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('closeSidebar');
        }
    });
</script>
<?php $__env->stopPush(); ?><?php /**PATH /home/chris/Projects/Taipei_Projects/mg.fg168.net/resources/views/livewire/admin/layout/admin-layout.blade.php ENDPATH**/ ?>