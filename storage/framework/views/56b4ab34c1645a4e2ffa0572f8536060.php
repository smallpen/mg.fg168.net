...
<?php $__env->startSection('title', '存取被拒絕'); ?>
    ...
    <div class="max-w-md w-full space-y-8">
        <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600">
                <?php echo e($exception->getMessage() ?: '您沒有權限存取此頁面'); ?>
...
<script>
    // 自動返回功能（可選）
    setTimeout(function() {
        const returnButton = document.querySelector('a[href="<?php echo e(route('admin.dashboard')); ?>"]');
        if (returnButton) {
            returnButton.focus();
        }
    }, 100);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chris/Projects/Taipei_Projects/mg.fg168.net/resources/views/errors/403.blade.php ENDPATH**/ ?>