            ...
            <div class="ml-4">
                ...
                <nav class="hidden sm:flex mt-1" aria-label="Breadcrumb">
                    <ol class="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
                        <li>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="hover:text-gray-700 dark:hover:text-gray-300">
                                管理後台
                            </a>
                        </li>
                        <?php if(!request()->routeIs('admin.dashboard')): ?>
                            <li class="flex items-center">
                                ...
                                <span class="text-gray-700 dark:text-gray-300"><?php echo e($pageTitle); ?></span>
                            </li>
                        <?php endif; ?>
                    </ol>
                </nav>
...
[$__name, $__params] = $__split('admin.layout.theme-toggle');

$__html = app('livewire')->mount($__name, $__params, 'lw-240486528-0', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('admin.language-selector');

$__html = app('livewire')->mount($__name, $__params, 'lw-240486528-1', $__slots ?? [], get_defined_vars());
            ...
            <div class="relative">
                <button wire:click="toggleUserMenu" 
                    ...
                    <div class="hidden sm:block text-left mr-2">
                        <p class="text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e($userDisplayName); ?></p>
                        <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($userEmail); ?></p>
                    </div>
...
[$__name, $__params] = $__split('admin.auth.logout-button', ['showText' => true, 'classes' => 'flex items-center w-full px-4 py-2 text-sm text-red-700 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20']);

$__html = app('livewire')->mount($__name, $__params, 'lw-240486528-2', $__slots ?? [], get_defined_vars());
...
</div><?php /**PATH /home/chris/Projects/Taipei_Projects/mg.fg168.net/resources/views/livewire/admin/layout/top-bar.blade.php ENDPATH**/ ?>